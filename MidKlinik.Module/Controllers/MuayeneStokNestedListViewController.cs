...
namespace MidKlinik.Module.Controllers
{
    ...
    public partial class MuayeneStokNestedListViewController : ViewController
    {
        public MuayeneStokNestedListViewController()
        {
            InitializeComponent();
        ...
        {
            base.OnActivated();
            ListPropertyEditor listPropertyEditor = ((DetailView)View).FindItem("MuayeneStokBilgisi") as ListPropertyEditor;
        ...
        {
            UpdateBool((MuayeneStok)((ListView)sender).CurrentObject);
        }

        private void UpdateBool(MuayeneStok currentObject)
        {
